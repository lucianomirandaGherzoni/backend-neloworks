...
const DIMENSION_MAXIMA = 150;  // cm por lado
const DIMENSION_MINIMA = 1;    // cm por lado

/**
 * @param {number} anchoAlfombra - Ancho de la alfombra en centímetros
 * @param {number} largoAlfombra - Largo de la alfombra en centímetros
...
export const calcularDimensionesAlfombra = (anchoAlfombra, largoAlfombra) => {
  ...
  // El lado más largo de la alfombra determina el largo del paquete
  ...
  // Ancho y alto del paquete escalan si el área supera la referencia
